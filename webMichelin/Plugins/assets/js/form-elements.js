var FormElements = function() {"use strict";
	...
	var timePickerHandler = function() {
	    ...
	    $('#timepicker-default_1').timepicker();
	    $('#timepicker-default_2').timepicker();
	    $('#timepicker-default_3').timepicker();
	    $('#timepicker-default_4').timepicker();
	    $('#timepicker-default_5').timepicker();
	    $('#timepicker-default_6').timepicker();
	};
