	...
	var settingsHandler = function() {
		...
		function switchLogo(theme) {
			switch (theme) {
				...
				case "theme-5":
				case "theme-6":
					$(".navbar-brand img").attr("src", "../Plugins/assets/images/logo2.png");
					break;

				default:
				    $(".navbar-brand img").attr("src", "../Plugins/assets/images/logo.png");
					break;
			}
		}
		...
		function defaultSetting() {
			...
			$('#skin_color').attr("href", "../Plugins/assets/css/themes/theme-1.css");
			$(".navbar-brand img").attr("src", "../Plugins/assets/images/logo.png");
