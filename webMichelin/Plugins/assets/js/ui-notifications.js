...
var showMessageAlert = function (cabecera,cuerpo,evento) {
    swal(cabecera, cuerpo, evento);

}
var result = {};

result.showMessageConfirmAnular = function (CallBack, OnError) {

    swal({
        title: "Desea continuar?",
        text: "Esta apunto de anular este item..",
        type: "warning",
